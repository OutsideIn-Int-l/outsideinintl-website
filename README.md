...
1. Create a repository (e.g. `outsideinintl-website`) and push these files to the root of the `main` branch.
...
2. At your DNS provider, add a **CNAME record**: `www` → `<username>.github.io`.
